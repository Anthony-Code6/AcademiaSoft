...
CREATE TABLE aula (
    ...
    codigo AS ('A' + RIGHT(CONVERT(VARCHAR, id), 1)),
    descripcion VARCHAR(200)
);

CREATE TABLE curso (
    id INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
    codigo AS ('C' + RIGHT(CONVERT(VARCHAR, id), 1)),
...
CREATE TABLE usuario (
    id INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
    codigo AS ('US' + RIGHT(CONVERT(VARCHAR, id), 2)),
...
CREATE TABLE profesor (
    id INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
    codigo AS ('PS' + RIGHT(CONVERT(VARCHAR, id), 2)),
...
CREATE TABLE alumno (
    id INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
    codigo AS ('AL' + RIGHT(CONVERT(VARCHAR, id), 2)),
    documento VARCHAR(20) NOT NULL,
    nombre VARCHAR(50) NOT NULL,
    apellido VARCHAR(50) NOT NULL,
    idusuario INT FOREIGN KEY REFERENCES usuario(id) ON UPDATE CASCADE ON DELETE NO ACTION
...
CREATE TABLE periodo (
    id INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
    codigo AS ('PR' + RIGHT(CONVERT(VARCHAR, id), 2)),
...
CREATE TABLE matricula (
    id INT NOT NULL IDENTITY(1,1) PRIMARY KEY,
    codigo AS ('M' + RIGHT(CONVERT(VARCHAR, id), 1)),
